        ...
        example_data_list = [
            {
                ...
                'Тип занятия': 'Лекция',
                'Преподаватель': 'Доцент Петров И.П.',
                'Аудитория': '301-К'
            },
            {
                'День недели': 'Вторник',
                ...
                'Тип занятия': 'Семинар',
                'Преподаватель': 'Профессор Иванова А.С.',
                'Аудитория': '402-А'
            },
            {
                'День недели': 'Среда',
                ...
                'Тип занятия': 'Лекция',
                'Преподаватель': 'Кандидат наук Сидоров В.В.',
            ...
            },
            {
                ...
                'Преподаватель': 'Ст. преподаватель Смирнова Е.Д.',
                'Аудитория': '215-Б'
            },
            {
                'День недели': 'Пятница',
                ...
                'Преподаватель': 'Ассистент Козлов А.И.',
                'Аудитория': 'Физ. лаб.'
            },
            {
                'День недели': 'Суббота',
                ...
                'Тип занятия': 'Консультация',
                'Преподаватель': 'Профессор Орлов П.Н.',
                'Аудитория': 'Онлайн'
            },

        ]
        return {'results': example_data_list}
